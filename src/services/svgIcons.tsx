...
export const LocationPinIcon = ({ size = 24, className }: IconProps): ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
...
export const WarningIcon = ({ size = 24, className }: IconProps): ReactElement => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SparkleIcon = ({ size = 16, className }: IconProps): ReactElement => (
  ...
  >
    ...
    <path d="M5 14l.7 1.8L7 16.5l-1.3.5L5 18.8l-.7-1.8L3 16.5l1.3-.7L5 14z" />
  </svg>
);
